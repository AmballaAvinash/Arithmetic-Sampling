...
python3 src/self_consistency.py --out_dir=outputs/self_identification --debug --verbose --seed=42 --run_id=0 --model=google/gemma-2b  --load_in_8bit --eval_inf_fn_key=zeroshot --eval_split=validation --dataset_name=strategy_qa --dataset_subname=None --eval_n_samples=2 --eval_retrieval_strategy=random --eval_output_sampling_strategy=all --dataset_sample_strategy=static --clean_out_dir=True
