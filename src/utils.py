...
from transformers.generation.utils import GenerateNonBeamOutput, GenerateOutput, GenerateEncoderDecoderOutput, GenerateDecoderOnlyOutput, validate_stopping_criteria
...
class GenerationMode(ExplicitEnum):
    ...
    SAMPLE = "sample"
    ARITHMETIC_SAMPLE = "arithmetic_sample"
...
class ArithmeticSamplingGenerationMixin(GenerationMixin):
    
    def _get_generation_mode(
        self, generation_config: ArithmeticSamplingGenerationConfig, assistant_model: Optional["PreTrainedModel"]
    ) -> GenerationMode:
        """
        ...
        if generation_config.constraints is not None or generation_config.force_words_ids is not None:
            ...
            elif generation_config.arithmetic_sampling:
                generation_mode = GenerationMode.ARITHMETIC_SAMPLE
            else:
    ...
    def generate(
        ...
        generation_config: Optional[ArithmeticSamplingGenerationConfig] = None,
        ...
        **kwargs,
        ...
        Parameters:
            ...
            generation_config (`~generation.ArithmeticSamplingGenerationConfig`, *optional*):
                The generation configuration to be used as base parametrization for the generation call. `**kwargs`
                passed to generate matching the attributes of `generation_config` will override them. If
                `generation_config` is not provided, the default will be used, which has the following loading
                priority: 1) from the `generation_config.json` model file, if it exists; 2) from the model
                configuration. Please note that unspecified parameters will inherit [`~generation.ArithmeticSamplingGenerationConfig`]'s
        ...
        elif generation_mode == GenerationMode.ARITHMETIC_SAMPLE:
