...
DATASET_ENUM = {
    "gsm8k": ("gsm8k", "main", "test", GSM8K_EXEMPLARS)
}
...
def load_HF_dataset(dataset_name: str, dataset_subname: str, dataset_split: str) -> Dataset:
...
def generate_few_shot_exemplars(dataset_name: str, num_examples: int = -1) -> str:
    ...
    for index in exemplar_indices:
        ...
        prompt_prefix += (
            ...
            + f"Answer: {COT_TRIGGER} {exemplar["reasoning"]} {ANSWER_TRIGGER} {exemplar["answer"]}.\n\n"
        )
